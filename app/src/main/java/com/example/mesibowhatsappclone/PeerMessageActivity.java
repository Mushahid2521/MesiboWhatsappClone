...
//        mesiboCallConfig.backgroundColor = 0x008BC34A;
...
//                mesiboCall.call(getApplicationContext(), Mesibo.random(), userProfile, false);
//                return true;
//            case R.id.action_videocall:
//                mesiboCall.call(getApplicationContext(), Mesibo.random(), userProfile, true);
//                return true;
//            default:
